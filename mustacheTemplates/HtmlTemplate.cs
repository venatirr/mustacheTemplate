														...
														<span style=""font: 100% Calibri, Verdana, Arial, Helvetica, sans-serif; font-size:14px; color:#333333; width:350px;"" width=""350px""><br>
															<!-- TemplateBeginEditable name=""Body Copy"" -->You just put someone’s phone back in action<br>
																...
																<table width=""580"">
																	...
																	<tr>
																		<td style=""color:#333333; font: 100% Calibri, Verdana, Arial, Helvetica, sans-serif; font-size:14px;"">Header for</td>
																	...
																	<tr>
																		...
																		<td style=""color:#333333; font: 100% Calibri, Verdana, Arial, Helvetica, sans-serif; font-size:14px;""><b>{{TransactionID}}</b></td>
																	</tr>
																	{{#each OrderItems}}
																			<tr/>
																			{{#if IsMobileRecharge}}
																			<th colspan=""2"" bgcolor=""#00623a"" style=""text-align:center; color:#ffffff;-webkit-border-top-left-radius: 8px;-webkit-border-top-right-radius: 8px;-moz-border-radius-topleft: 8px;-moz-border-radius-topright: 8px;border-top-left-radius: 8px;border-top-right-radius: 8px; font: 100% Calibri, Verdana, Arial, Helvetica, sans-serif; font-size:14px;""><b>Mobile recharge details</b></th>
																			<tr>
																				<td style=""color:#333333; font: 100% Calibri, Verdana, Arial, Helvetica, sans-serif; font-size:14px;"">Detail 1</td>
																				<td style=""color:#333333; font: 100% Calibri, Verdana, Arial, Helvetica, sans-serif; font-size:14px;""><b>{{Detail1}}</b></td>
																			</tr>
																			<tr>
																				<td style=""color:#333333; font: 100% Calibri, Verdana, Arial, Helvetica, sans-serif; font-size:14px;"">Detail 2</td>
																				<td style=""color:#333333; font: 100% Calibri, Verdana, Arial, Helvetica, sans-serif; font-size:14px;""><b>{{Detail2}}</b></td>
																			</tr>
																			<tr>
																			...
																			{{/if}}
																			{{#if IsIld}}
																			<th colspan=""2"" bgcolor=""#00623a"" style=""text-align:center; color:#ffffff;-webkit-border-top-left-radius: 8px;-webkit-border-top-right-radius: 8px;-moz-border-radius-topleft: 8px;-moz-border-radius-topright: 8px;border-top-left-radius: 8px;border-top-right-radius: 8px; font: 100% Calibri, Verdana, Arial, Helvetica, sans-serif; font-size:14px;""><b>ILD details</b></th>
																			<tr>
																				<td style=""color:#333333; font: 100% Calibri, Verdana, Arial, Helvetica, sans-serif; font-size:14px;"">ILD details</td>
																				<td style=""color:#333333; font: 100% Calibri, Verdana, Arial, Helvetica, sans-serif; font-size:14px;""><b>{{Detail2}}</b></td>
																			</tr>
																			{{/if}}
																			<tr/>
